...
public abstract class AbstractOwncloudUserModificationServiceRestTest
  ...
  private void prepareModificationRestTest(UserModification userModification) throws IOException {
    if (userModification.getExistingUser() != null) {
      respondUser(
          RestRequest.builder().method(GET).url("/cloud/users/" + userModification.getExistingUser().getUsername())
              .build(),
          userModification.getExistingUser().isEnabled(), userModification.getExistingUser().getEmail(),
          userModification.getExistingUser().getDisplayName());
    } else {
      respondFailure(
          RestRequest.builder().method(GET).url("/cloud/users/" + userModification.getNewUser().getUsername()).build(),
      ...
      respondUser(
          RestRequest.builder().method(GET).url("/cloud/users/" + userModification.getNewUser().getUsername()).build(),
          true, null, userModification.getNewUser().getUsername());
    }

    // change the Displayname
    if (userModification.getExistingUser() == null || !StringUtils
        .equals(userModification.getExistingUser().getDisplayName(), userModification.getNewUser().getDisplayName())) {
      if (userModification.isErrorUpdateDisplayName()) {
        ...
        respondSuccess(RestRequest.builder().method(PUT)
            .url("/cloud/users/" + userModification.getNewUser().getUsername()).build(), putData);
      }
    }

    // change the eMail
    if (userModification.getExistingUser() == null || !StringUtils.equals(userModification.getExistingUser().getEmail(),
    ...
    if (userModification.getExistingUser() != null
      ...
      if (userModification.isErrorEnableDisable()) {
        ...
        respondSuccess(
            RestRequest.builder().method(PUT).url("/cloud/users/" + userModification.getNewUser().getUsername() + "/"
                + (userModification.getNewUser().isEnabled() ? "enable" : "disable")).build());
      }
    }
    ...
    if (userModification.isErrorAddGroup()) {
      ...
      for (String group : addedGroups) {
        ...
        respondSuccess(RestRequest.builder().method(POST)
            .url("/cloud/users/" + userModification.getNewUser().getUsername() + "/groups").build(), postData);
      }
    }
    ...
    respondUser(
        RestRequest.builder().server(queryServer).method(GET)
            .url("/cloud/users/" + userModification.getNewUser().getUsername()).build(),
        userModification.getNewUser().isEnabled(), userModification.getNewUser().getEmail(),
  ...
  protected void prepareTestSaveUser_UpdateUser_OK_WithoutGroups(OwncloudModificationUser existingUser,
    ...
    prepareModificationRestTest(UserModification.builder().existingUser(existingUser).newUser(updateUser).build());
  }
  ...
  protected void prepareTestCreateGroup_OK(String groupname) throws Exception {
    respondSuccess(RestRequest.builder().method(POST).url("/cloud/groups/" + groupname).build());
  }
  ...
  protected void prepareTestDeleteGroup_NOK_GroupNotFound(String groupname) throws Exception {
    respondFailure(RestRequest.builder().method(DELETE).url("/cloud/groups/" + groupname).build(), 101);
  }
  ...
  public void testSaveUser_UpdateUser_NOK_UpdateDisplayName_IllegalStateException_UsernameNotFound() throws Exception {
    OwncloudModificationUser existingUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(true).displayName("Mrs. User 5").email("user5@example.com").build();

    OwncloudModificationUser updateUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(false).displayName("changed Value").email("changed Value").build();
  ...
  public void testSaveUser_UpdateUser_NOK_UpdateEmail_IllegalStateException_UsernameNotFound() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeUpdateEmail(101).build());
  ...
  public void testSaveUser_UpdateUser_NOK_UpdateEmail_IllegalStateException() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeUpdateEmail(102).build());
  ...
  public void testSaveUser_UpdateUser_NOK_UpdateEmail_AccessDenied() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeUpdateEmail(997).build());
  ...
  public void testSaveUser_UpdateUser_NOK_UpdateEmail_UnknownError() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeUpdateEmail(999).build());
  ...
  public void testSaveUser_UpdateUser_NOK_Enable_IllegalStateException_UsernameNotFound() throws Exception {
    OwncloudModificationUser existingUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(false).displayName("Mrs. User 5").email("user5@example.com").build();

    OwncloudModificationUser updateUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(true).displayName("changed Value").email("changed Value").build();

    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeEnableDisable(101).build());
  ...
  public void testSaveUser_UpdateUser_NOK_Enable_IllegalStateException() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeEnableDisable(102).build());
  ...
  public void testSaveUser_UpdateUser_NOK_Enable_AccessDenied() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeEnableDisable(997).build());
  ...
  public void testSaveUser_UpdateUser_NOK_Enable_UnknownError() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeEnableDisable(999).build());
  ...
  public void testSaveUser_UpdateUser_NOK_AddGroup_IllegalArgumentException() throws Exception {
    OwncloudModificationUser existingUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(true).displayName("Mrs. User 5").email("user5@example.com").group("group1").build();

    OwncloudModificationUser updateUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(false).displayName("changed Value").email("changed Value").group("group1").group("group2").build();

    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeAddGroup(101).build());
  ...
  public void testSaveUser_UpdateUser_NOK_AddGroup_OwncloudGroupNotFoundException() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeAddGroup(102).build());
  ...
  public void testSaveUser_UpdateUser_NOK_AddGroup_IllegalStateException_UsernameNotFound() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeAddGroup(103).build());
  ...
  public void testSaveUser_UpdateUser_NOK_AddGroup_AccessDeniedException_NotAllowedToAddGroup() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeAddGroup(104).build());
  ...
  public void testSaveUser_UpdateUser_NOK_AddGroup_IllegalStateException() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeAddGroup(105).build());
  ...
  public void testSaveUser_UpdateUser_NOK_AddGroup_AccessDeniedException_NoPermissions() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeAddGroup(997).build());
  ...
  public void testSaveUser_UpdateUser_NOK_AddGroup_UnknownError() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeAddGroup(999).build());
  ...
  public void testSaveUser_UpdateUser_NOK_RemoveGroup_IllegalArgumentException() throws Exception {
    OwncloudModificationUser existingUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(true).displayName("Mrs. User 5").email("user5@example.com").group("group1").group("group2").build();

    OwncloudModificationUser updateUser = OwncloudModificationUser.builder().username("user5").password("password")
        .enabled(false).displayName("changed Value").email("changed Value").group("group1").build();

    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeRemoveGroup(101).build());
  ...
  public void testSaveUser_UpdateUser_NOK_RemoveGroup_OwncloudGroupNotFoundException() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeRemoveGroup(102).build());
  ...
  public void testSaveUser_UpdateUser_NOK_RemoveGroup_IllegalStateException_UsernameNotFound() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeRemoveGroup(103).build());
  ...
  public void testSaveUser_UpdateUser_NOK_RemoveGroup_AccessDeniedException_NotAllowedToRemoveGroup() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeRemoveGroup(104).build());
  ...
  public void testSaveUser_UpdateUser_NOK_RemoveGroup_IllegalStateException() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeRemoveGroup(105).build());
  ...
  public void testSaveUser_UpdateUser_NOK_RemoveGroup_AccessDeniedException_NoPermissions() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeRemoveGroup(997).build());
  ...
  public void testSaveUser_UpdateUser_NOK_RemoveGroup_UnknownError() throws Exception {
    ...
    prepareModificationRestTest(
        UserModification.builder().existingUser(existingUser).newUser(updateUser).errorCodeRemoveGroup(999).build());
  ...
  public void testCreateGroup_NOK_IllegalArgumentException() throws Exception {
    respondFailure(RestRequest.builder().method(POST).url("/cloud/groups/group4").build(), 101);
  ...
  public void testCreateGroup_NOK_CannotCreateGroup() throws Exception {
    respondFailure(RestRequest.builder().method(POST).url("/cloud/groups/group4").build(), 103);
    userModificationService.createGroup("group4");
  }
  ...
  public void testCreateGroup_NOK_AccessDeniedException() throws Exception {
    respondFailure(RestRequest.builder().method(POST).url("/cloud/groups/group4").build(), 997);
    userModificationService.createGroup("group4");
  }
  ...
  public void testCreateGroup_NOK_UnknownError() throws Exception {
    respondFailure(RestRequest.builder().method(POST).url("/cloud/groups/group4").build(), 999);
    userModificationService.createGroup("group4");
  }
  ...
  public void testDeleteGroup_NOK_CannotDeleteGroup() throws Exception {
    respondFailure(RestRequest.builder().method(DELETE).url("/cloud/groups/group4").build(), 102);
  ...
  public void testDeleteGroup_NOK_AccessDeniedException() throws Exception {
    respondFailure(RestRequest.builder().method(DELETE).url("/cloud/groups/group4").build(), 997);
    userModificationService.deleteGroup("group4");
  }
  ...
  public void testDeleteGroup_NOK_UnknownError() throws Exception {
    respondFailure(RestRequest.builder().method(DELETE).url("/cloud/groups/group4").build(), 999);
    userModificationService.deleteGroup("group4");
  }
