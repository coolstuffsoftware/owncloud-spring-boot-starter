...
public abstract class AbstractOwncloudUserDetailsServiceRestTest extends AbstractOwncloudUserDetailsServiceTest
  ...
  protected void prepareTestUserDetails_OK(String user, boolean enabled, String email, String displayName,
    ...
    respondUser(RestRequest.builder().method(GET).url("/cloud/users/" + user).build(), enabled, email, displayName);
  ...
  protected void prepareTestUserDetails_NotFound() throws Exception {
    respondFailure(RestRequest.builder().method(GET).url("/cloud/users/unknown").build(), 998,
  ...
  public void testUserDetails_AccessDenied() throws Exception {
    respondFailure(RestRequest.builder().method(GET).url("/cloud/users/user1").build(), 997);
  ...
  public void testUserDetails_UnknownError() throws Exception {
    respondFailure(RestRequest.builder().method(GET).url("/cloud/users/user1").build(), 999);
