...
@ActiveProfiles("LOCAL-RESOURCE-QUOTA-EXCEEDED-SERVICE")
@TestExecutionListeners({
    OwncloudLocalResourceServiceEmptyDirectoryTestExecutionListener.class
})
public class OwncloudLocalResourceServiceQuotaExceededTest extends AbstractOwncloudResourceServiceQuotaExceededTest {
