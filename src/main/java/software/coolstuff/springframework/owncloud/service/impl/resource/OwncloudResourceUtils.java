...
final class OwncloudResourceUtils {
  ...
  public static void validateUserNotNull(OwncloudResourceData.User user, String username) {
    if (user == null) {
      throw new UsernameNotFoundException(username);
    }
  }

  public static void validateGroupNotNull(OwncloudResourceData.Group group, String groupname) {
    if (group == null) {
